        ...
        <ul class="sidebar-menu">
            ...
            @if(CRUDBooster::isSuperadmin())
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="nav-link" href="{{Route("StatisticBuilderControllerGetAdd")}}">{{ cbLang('Add_New_Statistic') }}</a></li>
                        <li><a class="nav-link" href="{{Route("StatisticBuilderControllerGetIndex")}}">{{ cbLang('List_Statistic') }}</a></li>
                    </ul>
                </li>
